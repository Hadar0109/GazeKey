...
- disposition: REVERTED FOR ISOLATION (T059) — the revert is not a verdict on the hypothesis
- change_git_sha: bedfb86 (touches `gazekey/calibration/fixation_gate.py` only; clean single-commit revert)
- keep_git_sha: n/a
- notes: >
