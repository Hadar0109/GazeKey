...
Small always-on-top picture-in-picture window to display live camera feed.
"""
...
class CameraPreviewWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Small PiP window size (scaled placement uses availableGeometry).
        ...
        self.preview_label.setFixedSize(260, 190)
        ...
        # Position window based on dock setting
        if self._dock == "top_right":
    ...
    def update_frame(self, frame):
        ...
        try:
            ...
            preview_height, preview_width = 190, 260
