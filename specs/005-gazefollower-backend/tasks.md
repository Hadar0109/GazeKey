...
- [X] T045 [US4] After accepted recalibration: `pygame.quit()`, `start_sampling()`, show keyboard, resume consume; pointing must be usable again without PCA4. **USER-REPORTED PASS** 2026-08-24 (second fresh official Preview + Calibration): GREEN ring, dwell, and OS typing resumed; previous SVR was not a fallback. Record: `runs/005-t045-recalibrate-20260824/summary.md`
- [X] T046 [US4] If the new calibration is not accepted or not usable: do not continue as if newly calibrated; do **not** fall back to the previous SVR; fail closed without PCA4; keep dwell/OS inject disabled; require Calibrate again (`gazekey/backend/lifecycle.py`, `contracts/lifecycle.md`). Operator 2026-08-24.
...
- [X] T054 [US5] **USER GATE session 1** — **USER-REPORTED PASS** 2026-08-24: live integrated keyboard succeeded; remaining gaze error small and accepted. Record: `runs/005-t054-20260824/summary.md`. SC-012 live official Preview + Calibration was **not** in this session; live reconfirm is T045 `runs/005-t045-recalibrate-20260824/summary.md`.
- [X] T055 [US5] **USER GATE session 2** — **USER-REPORTED PASS** 2026-08-24 distinct run: letters, editing keys, suggestions; plus T058 blink/invalid gaze, T059 OS typing, T060 suggestion accept. Record: `runs/005-t055-20260824/summary.md`. An earlier SC-012 live note in this session was later found broken (no GREEN/dwell after second calib) and is **not** the SC-012 PASS. Residual error still accepted; no accuracy/key-size/path change. Does **not** by itself satisfy SC-001 (needs T056).
- [X] T056 [US5] **USER GATE session 3** — **USER-REPORTED PASS** 2026-08-24 distinct chin/head-support run: letters, editing keys, suggestions visible, dwell usable, OS typing. Residual error accepted; no accuracy/key-size work. Record: `runs/005-t056-20260824/summary.md`. Recalibration was not required. Completes SC-001.
- [X] T057 [US5] **USER GATE** — **deferred / not scored** 2026-08-24: do **not** record or evaluate `hadar` as an accuracy metric. Operator restated after T056: no accuracy work, no key resize. Record: `runs/_feature005/T057_hadar_deferred.md`. Must not override SC-006 / unreachable-control failures. SC-010 is not a cleanup gate.
- [X] T058 [US5] **USER GATE** — **USER-REPORTED PASS** 2026-08-24 (session 2): natural blink / invalid gaze does not complete dwell and does not type. Openness threshold not retuned. No hold-last.
- [X] T059 [US5] **USER GATE** — **USER-REPORTED PASS** 2026-08-24 (session 2): real typing into an external application through ActionDispatcher / OS inject
- [X] T060 [US5] **USER GATE (Feature 005 suggestion selection)** — **USER-REPORTED PASS** 2026-08-24 (session 2): suggestion gaze-selection works; accepting a suggestion types the expected suffix + Space. This is not Feature 004 T060.
- [X] T061 [P] [US5] Optional second-user smoke test **explicit skip** 2026-08-24: `runs/_feature005/T061_second_user_skip.md` (FR-035 / SC-019). Restated in T062 `integrated_acceptance.md`.
- [X] T062 [US5] `runs/_feature005/integrated_acceptance.md` verdict **PASS** 2026-08-24: SC-001 three distinct sessions (T054/T055/T056); SC-012 T045 live recalibration; T057 `hadar` deferred / not scored and is not the cleanup trigger. Replay incompleteness stated. Feature 004 T060 formulas are not the cleanup trigger.
- [X] T063 [US5] **Cleanup hold released** 2026-08-24. T062 PASS. T056 PASS. T057 deferred (not scored). Stage G may begin at T064 after these records are on the checkpoint commit. Do not start deletions in T064.

**Checkpoint**: Integrated product accepted on three chin-support sessions (T062 PASS) and cleanup hold released (T063). Stage G may begin at T064.
