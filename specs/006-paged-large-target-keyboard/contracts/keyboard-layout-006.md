...
| Page switch | `system:page_right` or `system:page_left` | One tall `gazeTarget` spanning three letter rows |
...
[ Q W E R T |          ]
[ A S D F G |    →     ]   ← arrow is one strip, not three buttons
[ Shift Z X C V ⌫ |    ]
...
5. Top-half window placement unchanged (Feature 002/003 policy).
